...
users = [{:user_id=>'sa4084',:name=>'Mark',:uni=>'mar4048'},
        {:user_id=>'jar2333',:name=>'Joseph',:uni=>'jo2333'},
...
authentications = [
        {:user_id=>'jar2333',:password=>"password"},
        {:user_id=>'sa4084', :password=>"password1"},
        {:user_id=>'aj3087', :password=>"password2"},
        {:user_id=>'ma4987', :password=>"password3"},
        {:user_id=>'sa4567', :password=>"password4"},
        {:user_id=>'trj2122',:password=>"password5"},
        {:user_id=>'sr5677', :password=>"password6"},
        {:user_id=>'rt6789', :password=>"password7"},
        {:user_id=>'ds2387', :password=>"password8"},
        {:user_id=>'br2346', :password=>"password9"},
]

...
#         @e = Event.create({:id => 1, :user_id => 1, :title => "TestMessageEvent", :description => "TestEventDescription", :date_posted => "2022-10-22 10:00:00", :start_date => "2022-10-25 10:00:00", :end_date => "2022-10-25 12:00:00"})
#       else
#         @e = Event.where(:id => 1)
#       end
#     end
#     it "cannot create a message for an event that does not exist" do
#       post :create, {:params => {:msg => "TestMessage", :id => 1, :uni => "jar2333"}}
